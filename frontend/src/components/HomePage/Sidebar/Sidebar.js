...
function Sidebar() {
  return (
    <div className=' bg-black text-white w-1/5  rounded-3xl flex flex-col items-center shadow-sm sidebar justify-between p-8' >
      <div className='flex flex-col'>
      <h3 className='lg:text-4xl md:text-2xl font-black leading-10 my-10 sidebar-text '>Board.</h3>
